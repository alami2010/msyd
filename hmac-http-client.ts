...
export class HmacHttpClient {
  ...
  constructor(_backend:ConnectionBackend, _defaultOptions:RequestOptions, accountEventsService:AccountEventsService, private http:Http) {
    //this.http = new Http(_backend, _defaultOptions);
